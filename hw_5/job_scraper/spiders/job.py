...
class JobScraperSpider(scrapy.Spider):
    ...
    start_urls = [f'https://hh.ru/search/vacancy?text={job_title}', f'https://www.superjob.ru/vacancy/search/?keywords={job_title}']
    ...
    def vacancy_parse(self, response: HtmlResponse):
        # get title, salaries+currency, link, source
        title = response.xpath(self.rules.get('title')).get('')
        ...
        source = f'{parsed_link.scheme}://{parsed_link.netloc}/'
